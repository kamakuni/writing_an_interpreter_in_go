...
func New(l *lexer.Lexer) *Parser {
	...
	// Register parser functions for prefix tokens
	// identifer, integer, !, -
...
func (p *Parser) peekPreference() int {
...
func (p *Parser) parseExpression(precedence int) ast.Expression {
	// get a prefix parser function suited for data type
	...
	for !p.peekTokenIs(token.SEMICOLON) && precedence < p.peekPreference() {
...
func (p *Parser) parseLetStatement() *ast.LetStatement {
	...
	// TODO: We're skipping the expressions util we
